...
@media(max-width:768px){
  ...
  .htd-room-price-row { flex-direction:column; align-items:flex-start; gap:10px; }
                                ...
                                <div class="col-md-8">
                                    <div class="htd-room-body">
                                        ...
                                        <div class="htd-room-price-row">
                                            ...
                                            @if($offerId)
                                            <form method="POST" action="{{ route('hotels.prebook') }}" style="margin:0;">
                                                @csrf
                                                <input type="hidden" name="offer_id" value="{{ $offerId }}">
                                                <button type="submit" class="htd-book-room-btn"><i class="fas fa-lock me-1"></i> Book This Room</button>
                                            </form>
                                            @endif
                                        </div>
                                    </div>
